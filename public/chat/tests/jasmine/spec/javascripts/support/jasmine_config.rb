...
# Override these methods if necessary
  ...
  def project_root
    # root = Dir.pwd + "/../../.."   # brings us to /faye/build/public/
    root = Dir.pwd + "/../../../../../.."   # brings us to /faye/build/public/
    puts root
    root
  end
...
#  Path to your jasmine.yml
 def simple_config_file
   File.join(project_root, 'faye/build/public/chat/tests/jasmine/spec/javascripts/support/jasmine.yml')
 end
...
#  Spec directory path. Your spec_files must be returned relative to this path.
  def spec_dir
    if simple_config['spec_dir']
      ...
      File.join(project_root, 'chat/tests/jasmine/spec/javascripts')
    end
  end

 # Return an array of filepaths relative to src_dir to include before jasmine specs.
 def src_files
   files = Dir.glob("../../../../../../geniverse-jetty/webapps/geniverse/geniverse/*.js")
   puts files[0]
   files
